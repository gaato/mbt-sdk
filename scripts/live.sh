#!/usr/bin/env bash
# Opt-in live tests against real LLM APIs. Reads OPENAI_API_KEY / OPENROUTER_API_KEY from the
...
export OPENAI_API_KEY="${OPENAI_API_KEY:-}" OPENROUTER_API_KEY="${OPENROUTER_API_KEY:-}"
